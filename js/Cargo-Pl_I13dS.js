...
function __wbg_adapter_24(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hbd6a972a88cb12c1(arg0, arg1);
}
...
class ScrollState {
    ...
    update() {
        const ret = wasm.scrollstate_update(this.__wbg_ptr);
        if (ret[1]) {
...
const module = new URL("assets/algorithmssite_page-CeOrhSiO.wasm", import.meta.url);
